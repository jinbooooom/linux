...
class FlatBufferBuilder {
 public:
  ...
  template<typename T>
  void Finish(Offset<T> root, const uoffset_t id = 0, const char *file_identifier = nullptr) {
    Finish(root.o, id, file_identifier, false);
  }
  ...
  template<typename T>
  void FinishSizePrefixed(Offset<T> root, const uoffset_t id = 0,
                          const char *file_identifier = nullptr
                          ) {
    Finish(root.o, id, file_identifier, true);
  }
...
protected:
  ...
  void Finish(uoffset_t root, const uoffset_t id, const char *file_identifier, bool size_prefix) {
    NotNested();
    buf_.clear_scratch();
